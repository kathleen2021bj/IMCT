...
parser.add_argument('-nc', '--num_of_clients', type=int, default=35, help='numer of the clients')
...
if __name__ == "__main__":
    ...
    sys.stdout = Logger('zishishibie_prox123456.txt')
    ...
    for i in range(args['num_comm']):
        ...
        model_eyi = torch.load("./model/model18")
        for var in global_parameters:
            global_parameters[var] = ((sum_parameters[var] + 15*model_eyi[var]) / (num_in_comm + 15))
        ...
        #     print('var1', var1)
        #     print('low_1', low_1)
        #     # avg_2 = sum(sum_avg_acc_sort_2) / 20
        ...
        #     #         print('第%d个节点被认为是恶意节点或未达到合约精度' % (30 + kb))
        #     #     else:
        #     #         print('第%d个节点被认为是正常节点' % (30 + kb))
        #     for kb in range(25):
